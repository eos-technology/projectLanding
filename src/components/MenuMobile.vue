  ...
  <div class="menu-mobile" v-show="burger==false" :class="{'in': !burger}">
    <ul>
      <li @click="burger=true" class="clip">
        <a class="link-medium txt-black" href="#invest">{{ $t('menu.investing') }}</a>
      </li>
      <li @click="burger=true" class="clip clip-1">
        <a class="link-medium txt-black" href="#options">{{ $t('menu.options') }}</a>
      </li>
      <li @click="burger=true" class="clip clip-2">
        <a class="link-medium txt-black" href="#startup">{{ $t('menu.startup') }}</a>
      </li>
